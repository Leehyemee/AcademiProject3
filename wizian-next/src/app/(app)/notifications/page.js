    ...
    return (
        <div className="main-content">
            <div className="container-fluid">
                ...
                <div id="toastr-demo" className="panel">
                    <div className="panel-body">

                        {/* CONTEXTUAL */}
                        <h4>Context</h4>
                        <p className="demo-button">
                            <button type="button" className="btn btn-primary btn-toastr" data-context="info"
                                    data-message="This is general theme info" data-position="top-right">General Info
                            </button>
                            <button type="button" className="btn btn-success btn-toastr" data-context="success"
                                    data-message="This is success info" data-position="top-right">Success Info
                            </button>
                            <button type="button" className="btn btn-warning btn-toastr" data-context="warning"
                                    data-message="This is warning info" data-position="top-right">Warning Info
                            </button>
                            <button type="button" className="btn btn-danger btn-toastr" data-context="error"
                        ...
                        <h4>Position</h4>
                        <p className="demo-button">
                            <button type="button" className="btn btn-default btn-toastr" data-context="info"
                        ...
                        <h4>Callback</h4>
                        <p className="demo-button">
                            <button type="button" className="btn btn-default btn-toastr-callback" id="toastr-callback1"
                                    data-context="info" data-message="onShown and onHidden callback demo">onShown and
                                onHidden
                            </button>
                            <button type="button" className="btn btn-default btn-toastr-callback" id="toastr-callback2"
                                    data-context="info" data-message="Please click me">onclick
                            </button>
                            <button type="button" className="btn btn-default btn-toastr-callback" id="toastr-callback3"
